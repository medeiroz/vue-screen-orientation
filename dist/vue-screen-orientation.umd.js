(function (global, factory) {
  ...
  (factory((global.VueScreenOrientation = {}),global.Vue));
  ...
  var install = function (Vue$$1) {
    Vue$$1.mixin(VueScreenOrientationMixin);
  };

  // Note that here we're not only exporting the install function, but
  // also the mixin itself - this is so with can `Vue.use()` or
  // `mixins: [],` it.
  var index = { install: install, VueScreenOrientationMixin: VueScreenOrientationMixin, VSO_USE_TYPE: VSO_USE_TYPE }
